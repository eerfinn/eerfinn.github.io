const projectsData = [
  ...
  // Dummy Projects for Testing Load More
  {
    id: 5,
    title: "E-Commerce Dashboard",
    description:
      "A comprehensive admin dashboard for e-commerce platforms featuring real-time analytics, order management, inventory tracking, and customer insights. Built with modern React architecture and integrated with REST APIs.",
    image: "https://via.placeholder.com/600x400/6366f1/ffffff?text=E-Commerce+Dashboard",
    screenshots: [],
  ...
  },
  {
    ...
    description:
      "A RESTful API backend service for task management applications. Features include user authentication, task CRUD operations, team collaboration, and real-time notifications using WebSocket.",
    image: "https://via.placeholder.com/600x400/10b981/ffffff?text=Task+API",
    screenshots: [],
  ...
  },
  {
    ...
    description:
      "A cross-platform mobile application that provides accurate weather forecasts, hourly predictions, and severe weather alerts. Features beautiful UI with smooth animations and offline support.",
  ...
  },
  {
    ...
    description:
      "A full-stack web application for tracking and analyzing social media performance across multiple platforms. Includes sentiment analysis, engagement metrics, and automated reporting.",
    image: "https://via.placeholder.com/600x400/8b5cf6/ffffff?text=Analytics+Platform",
    screenshots: [],
